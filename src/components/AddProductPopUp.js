...
const AddProductPopUp = ({ ref }) => {
    ...
    const handleSubmit = () => {
        console.log("Producto añadido", type, descripcion, cosecha, cantidad, precio_euros, precio_dolares)
    }
    ...
    return (
        <>
            <dialog className="add-product-dialog" ref={ref}>
                ...
                <form className="add-product-form" submit={handleSubmit}>
                    ...
                    <button type="submit">Añadir producto</button>
                </form>
            </dialog>
        </>
    )
